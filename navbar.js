var topNav = `<nav id="primary_nav_wrap">
<ul>
  ...
  <li><a href="#">Data Science</a>
    <ul>
      ...
      <li><a href="#">Probability</a>
        <ul>
          <li><a href="#">Fundamentals</a></li>
          <li><a href="#">Combinatronics</a></li>
          <li><a href="#">Bayesian</a></li>
        </ul> 
      </li>
      <li><a href="#">Tooling</a>
        <ul>
